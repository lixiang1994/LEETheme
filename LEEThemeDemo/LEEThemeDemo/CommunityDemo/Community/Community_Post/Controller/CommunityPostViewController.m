...
- (void)initSubview{
    ...
    [contentAttributes setObject:[UIColor leeTheme_ColorFromJsonWithTag:[LEETheme currentThemeTag] WithIdentifier:common_font_color_3] forKey:NSForegroundColorAttributeName];
...
- (void)insertImageArray:(NSArray *)imageArray{
    ...
    contentText.color = [UIColor leeTheme_ColorFromJsonWithTag:[LEETheme currentThemeTag] WithIdentifier:common_font_color_3];
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    switch (buttonIndex) {
        ...
        case 1:
        {
            ...
            imagePickerVC.navigationBar.barTintColor = [UIColor leeTheme_ColorFromJsonWithTag:[LEETheme currentThemeTag] WithIdentifier:common_bg_blue_4];
            
            imagePickerVC.oKButtonTitleColorDisabled = [UIColor lightGrayColor];
            
            imagePickerVC.oKButtonTitleColorNormal = [UIColor leeTheme_ColorFromJsonWithTag:[LEETheme currentThemeTag] WithIdentifier:common_bg_blue_4];
