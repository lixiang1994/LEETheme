...
#define kWBCellNameNormalColor_Night UIColorHex(777777) // 名字颜色
#define kWBCellNameOrangeColor_Night UIColorHex(f26220) // 橙名颜色 (VIP)
#define kWBCellTimeNormalColor_Night UIColorHex(555555) // 时间颜色
#define kWBCellTimeOrangeColor_Night UIColorHex(f28824) // 橙色时间 (最新刷出)

#define kWBCellTextNormalColor_Night UIColorHex(777777) // 一般文本色
#define kWBCellTextSubTitleColor_Night UIColorHex(5d5d5d) // 次要文本色
#define kWBCellTextHighlightColor_Night UIColorHex(527ead) // Link 文本色
#define kWBCellTextHighlightBackgroundColor_Night UIColorHex(bfdffe) // Link 点击背景色
#define kWBCellToolbarTitleColor_Night UIColorHex(555555) // 工具栏文本色
#define kWBCellToolbarTitleHighlightColor_Night UIColorHex(df422d) // 工具栏文本高亮色

#define kWBCellBackgroundColor_Night UIColorHex(1b1b1b)    // Cell背景灰色
#define kWBCellHighlightColor_Night UIColorHex(222222)     // Cell高亮时灰色
#define kWBCellInnerViewColor_Night UIColorHex(2b2b2b)   // Cell内部卡片灰色
#define kWBCellInnerViewHighlightColor_Night  UIColorHex(1b1b1b) // Cell内部卡片高亮时灰色
#define kWBCellLineColor_Night [UIColor colorWithWhite:0.000 alpha:0.09] //线条颜色
