...
//    text.color = kWBCellToolbarTitleColor;
    ...
    text.color = isDay ? kWBCellToolbarTitleColor : kWBCellToolbarTitleColor_Night;
...
//    nameText.color = user.mbrank > 0 ? kWBCellNameOrangeColor : kWBCellNameNormalColor;
    ...
    nameText.color = user.mbrank > 0 ? (isDay ? kWBCellNameOrangeColor : kWBCellNameOrangeColor_Night) : (isDay ? kWBCellNameNormalColor : kWBCellNameNormalColor_Night);
...
- (void)_layoutSource {
    ...
    if (createTime.length) {
        ...
        timeText.color = isDay ? kWBCellTimeNormalColor : kWBCellTimeNormalColor_Night;
    ...
    if (_status.source.length) {
        ...
        if (href.length && text.length) {
            ...
            from.color = isDay ? kWBCellTimeNormalColor : kWBCellTimeNormalColor_Night;
            ...
            if (_status.sourceAllowClick > 0) {
                ...
                [from setColor:isDay ? kWBCellTextHighlightColor : kWBCellTextHighlightColor_Night range:range];
                ...
                border.fillColor = isDay ? kWBCellTextHighlightBackgroundColor : kWBCellTextHighlightBackgroundColor_Night;
...
- (void)_layoutText {
    ...
    NSMutableAttributedString *text = [self _textWithStatus:_status
                                                  ...
                                                  textColor:isDay ? kWBCellTextNormalColor : kWBCellTextNormalColor_Night];
...
- (void)_layoutRetweetedText {
    ...
    NSMutableAttributedString *text = [self _textWithStatus:_status.retweetedStatus
                                                  ...
                                                  textColor:isDay ? kWBCellTextSubTitleColor : kWBCellTextSubTitleColor_Night];
    if (text.length == 0) return;
...
//            title.color = kWBCellNameNormalColor;
            ...
            title.color = isDay ? kWBCellNameNormalColor : kWBCellNameNormalColor_Night;
...
//            desc.color = kWBCellNameNormalColor;
            ...
            desc.color = isDay ? kWBCellNameNormalColor : kWBCellNameNormalColor_Night;
...
//            content3.color = kWBCellTextSubTitleColor;
            ...
            content3.color = isDay ? kWBCellTextSubTitleColor : kWBCellTextSubTitleColor_Night;
...
//            tips.color = kWBCellTextSubTitleColor;
            ...
            tips.color = isDay ? kWBCellTextSubTitleColor : kWBCellTextSubTitleColor_Night;
...
//        highlightBorder.fillColor = kWBCellTextHighlightBackgroundColor;
        ...
        highlightBorder.fillColor = isDay ? kWBCellTextHighlightBackgroundColor : kWBCellTextHighlightBackgroundColor_Night;
        
//        [text setColor:kWBCellTextHighlightColor range:text.rangeOfAll];
        
        [text setColor:isDay ? kWBCellTextHighlightColor : kWBCellTextHighlightColor_Night range:text.rangeOfAll];
...
//    repostText.color = kWBCellToolbarTitleColor;
    ...
    repostText.color = isDay ? kWBCellToolbarTitleColor : kWBCellToolbarTitleColor_Night;
...
//    commentText.color = kWBCellToolbarTitleColor;
    ...
    commentText.color = isDay ? kWBCellToolbarTitleColor : kWBCellToolbarTitleColor_Night;
...
//    likeText.color = _status.attitudesStatus ? kWBCellToolbarTitleHighlightColor : kWBCellToolbarTitleColor;
    ...
    likeText.color = _status.attitudesStatus ? (isDay ? kWBCellToolbarTitleHighlightColor : kWBCellToolbarTitleHighlightColor_Night) : (isDay ? kWBCellToolbarTitleColor : kWBCellToolbarTitleColor_Night);
...
//                replace.color = kWBCellTextHighlightColor;
                ...
                replace.color = isDay ? kWBCellTextHighlightColor : kWBCellTextHighlightColor_Night;
...
//                [text setColor:kWBCellTextHighlightColor range:range];
                ...
                [text setColor:isDay ? kWBCellTextHighlightColor : kWBCellTextHighlightColor_Night range:range];
...
//            [text setColor:kWBCellTextHighlightColor range:at.range];
            ...
            [text setColor:isDay ? kWBCellTextHighlightColor : kWBCellTextHighlightColor_Night range:at.range];
