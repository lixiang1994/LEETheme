...
- (UIView *)promptBarView{
    ...
    if (!_promptBarView) {
        ...
        _promptBarView.backgroundColor = [[UIColor leeTheme_ColorFromJsonWithTag:[LEETheme currentThemeTag] WithIdentifier:common_bg_blue_4] colorWithAlphaComponent:0.8f];
